  ...
  <main class="content">
    <div class="container mt-4">
      ...
      <div class="control-bar">
        ...
        <form class="search-form" action="${pageContext.request.contextPath}/admin/parking/history" method="get">
          <select name="isExited" class="form-select me-2">
            <option value="">전체</option>
            <option value="true" ${param.isExited == 'true' ? 'selected' : ''}>출차완료</option>
            <option value="false" ${param.isExited == 'false' ? 'selected' : ''}>주차중</option>
          </select>
          ...
          <div class="card text mb-4">
              <div class="card-body text-center">
                  ...
                  <p class="card-text fs-4"><strong>${parkingCount}</strong>대</p>
              </div>
          </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
              ...
              <th scope="col" class="text-center">출차 여부</th>
          </tr>
          </thead>
          <tbody>
